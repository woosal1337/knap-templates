...
Publish a GitHub release only after the automated and desktop checks pass.

Complete the mobile checks before a Community directory request. Record any open mobile test in the GitHub release notes.
